...
export const OfficeTable = (props: any) => {
          ...
          <Table>
            ...
            <TableBody>
              {items.map((office: any) => {
                ...
                const created_at = format(Date.parse(office.created_at), "dd/MM/yyyy");
                ...
                const handleEdit = (event: React.ChangeEvent<HTMLInputElement>) => {
                  router.push(`/offices/edit-office/${office.id}`);
                };
                ...
                return (
                  <TableRow hover key={office.id} selected={isSelected}>
                    ...
                    <TableCell style={{direction:"ltr"}}>{office.phone}</TableCell>
