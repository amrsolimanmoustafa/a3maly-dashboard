...
export const OrdersSearch = (props: any) => {
  ...
  const { filter, onSearchChange , options ,handleSelect, handleChangeStartDate, handleChangeEndDate, handleExport, handleRequest, anchorEl,setAnchorEl,handleClose,selectedOption,handleClear, handleChange} = props;
