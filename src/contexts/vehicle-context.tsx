...
const VehicleContextProvider = ({ children }: any) => {
  ...
  const fetchVehicles = (page: number, rowsPerPage: number, filter?: string) => {
    axiosClient
  ...
  const fetchUnverifiedVehicles = (page: number, rowsPerPage: number, filter?: string) => {
    axiosClient
...
export type vehicleContextType = {
  fetchVehicles: (page: number, rowsPerPage: number, filter?: string) => void;
  fetchUnverifiedVehicles: (page: number, rowsPerPage: number, filter?: string) => void;
  vehicles: any[];
